          ...
          <div className="p-6.5">
            <div className="mb-5">
              ...
              {form?.comments &&
                form?.comments.map((c) => {
                  return (
                    <div key={c._id} className="flex justify-between p-4">
                      <div>
                        <p>{c.content}</p>{" "}
                        <img
                          src={`${
                      ...
                      <button
                        className="hover:text-primary text-md flex h-[50px] w-[50px] items-center gap-2 rounded-sm px-4 py-1.5 text-left hover:bg-gray dark:hover:bg-meta-4"
                        onClick={() =>
              ...
              <form className='flex items-center justify-between space-x-4.5' onSubmit={onSubmitHandler}>
                <div className='relative w-full'>
                  ...
                  />
                    {content.comment && (
                <div className="text-sm text-red">{content.comment}</div>
              )}
